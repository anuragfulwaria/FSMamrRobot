...
class config_srvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type config_srvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type config_srvRequest
    let len;
    let data = new config_srvRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new config_srvRequest(null);
...
class config_srvResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type config_srvResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type config_srvResponse
    let len;
    let data = new config_srvResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'roboteq_motor_controller_driver/config_srvResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new config_srvResponse(null);
...
module.exports = {
  Request: config_srvRequest,
  Response: config_srvResponse,
  md5sum() { return 'c6a1a0e621254ff7bba438d5bd95fa58'; },
  datatype() { return 'roboteq_motor_controller_driver/config_srv'; }
};
